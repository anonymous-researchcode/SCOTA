...
from semantic_segmentation.semseg.models.base import BaseModel
from semantic_segmentation.semseg.models.heads import * 
...
class ETABmodel(BaseModel):
    ...
    def fit(self, 
        ...
        callbacks   = init_callbacks(ckpt_dir) if ckpt_dir else None
        self.device = device
        ...
        log = self.model.fit_generator(train_loader, 
                                 valid_loader, 
                                 epochs=n_epoch, 
                                 callbacks=callbacks, 
                                 verbose=verbose)
